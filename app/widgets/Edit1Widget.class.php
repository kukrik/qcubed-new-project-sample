<?php
	...
	class Edit1Widget extends QDialog {
		...
		protected $strTemplate = '../widgets/Edit1Widget.tpl.php';
		protected $strCssClass = 'edit1_widget';
		...
		public function __construct($strCloseCallback, $objParentObject, $strControlId = null) {
			...
			$this->pnlValueDisplay->CssClass = 'calculator_display';
                        ...
                        //$this->pnlValueDisplay->AddChildControl(new QSelectable($this));
                        $this->listBox1 = new QListBox($this);
                        $this->listBox1->AddItems(array('key1'=>'vrednost1','key2'=>'vrednost2'));
                        $this->listBox1->AddAction(new QSelectEvent(), new QAjaxControlAction($this,'listBox1_Selected' ) );
		...
		public function btnUpdate_Click() {
			...
			$this->fltValue = $this->listBox1->SelectedItem->Name ;
...
//                public function listBox1_Selected() {
//                    
//                }
