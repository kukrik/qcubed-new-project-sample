...
if (!defined('SERVER_INSTANCE')) {
	...
	switch (SERVER_INSTANCE) {
		...
		case 'prod':
			 ...
			 */
			define ('__PROJECT__', __DOCROOT__ . __SUBDIRECTORY__ . '/qcubed-new-project-sample/app');
			...
			define ('__URL_REWRITE__', 'apache');
                        ...
                        define('__VIEW__', __PROJECT__.'/view');
			...
			//define ('__PLUGINS__', __DOCROOT__ . __SUBDIRECTORY__ . '/vendor/qcubed/plugin');
                        ...
                        //plugins per project
                        define ('__PLUGINS__', __PROJECT__ . '/includes/plugins');
