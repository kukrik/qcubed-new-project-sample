...
if (!defined('SERVER_INSTANCE')) {
	...
	switch (SERVER_INSTANCE) {
		...
		case 'prod':
			...
			define ('__SUBDIRECTORY__', '/frameworks/qcubed-alpha-3.0');
			 ...
			 */
                        define ('__PROJECT_NAME__','Qcubed simple project' );
			define ('__PROJECT__', __DOCROOT__ . __SUBDIRECTORY__ . '/qcubed-new-project-sample');
			define ('__INCLUDES__', __PROJECT__ . '/app/includes');
			...
			define ('__URL_REWRITE__', 'apache');
                        ...
                        /* Define controller views folder */
                        define('__VIEW__', __PROJECT__.'/app/view');
			...
			//define ('__PLUGINS__', __DOCROOT__ . __SUBDIRECTORY__ . '/vendor/qcubed/plugin');
                        ...
                        //plugins per project
                        define ('__PLUGINS__', __PROJECT__ . '/app/includes/plugins');

			define ('__TMP__', __PROJECT__  . '/app/tmp');
			...
			define ('__MODEL_GEN__', __PROJECT__ . '/app/generated/model_base' );
			define ('__META_CONTROLS__', __INCLUDES__ . '/meta_controls' );
			define ('__META_CONTROLS_GEN__', __PROJECT__ . '/app/generated/meta_base' );
			...
			define ('__FORMBASE_CLASSES__', __PROJECT__ . '/app/generated/form_base');
			...
			define ('__PLUGIN_ASSETS__',  __PROJECT_ASSETS__ . '/plugin');
			...
			define ('__JQUERY_EFFECTS__', ' http://ajax.googleapis.com/ajax/libs/jqueryui/1.11.1/jquery-ui.min.js');
			
			// The original, non-minified jQuery for debugging purposes.
			//define ('__JQUERY_BASE__', ' http://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.js,jquery/jquery-migrate.js');
			//define ('__JQUERY_EFFECTS__', ' http://ajax.googleapis.com/ajax/libs/jqueryui/1.9.2/jquery-ui.js');
